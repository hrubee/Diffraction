...
#
# Start Diffract auxiliary services: Telegram bridge
...
# ── Parse flags ──────────────────────────────────────────────────
SANDBOX_NAME="${DIFFRACTION_SANDBOX:-${SANDBOX_NAME:-default}}"
ACTION="start"
...
PIDDIR="/tmp/diffract-services-${SANDBOX_NAME}"
...
do_start() {
  ...
  echo "  │                                                     │"
  echo "  │  Run 'diffract term' to monitor egress approvals   │"
  echo "  └─────────────────────────────────────────────────────┘"
  echo ""
}
