# Contributing to NVIDIA Diffract Documentation

This guide covers how to write, edit, and review documentation for NVIDIA Diffract. If you change code that affects user-facing behavior, update the relevant docs in the same PR.
...
| Superlatives | "Diffract provides a powerful, robust, seamless experience." | Say what it does, not how great it is. |
...
| Diffract | Open Shell, openShell, Openshell, diffract |
| mTLS | MTLS, mtls |
| YAML | yaml, Yaml |
