...
description: Use pre-built sandboxes from the Diffract Community catalog or contribute your own.
topics:
- Generative AI
- Cybersecurity
tags:
...
Use pre-built sandboxes from the Diffract Community catalog, or contribute your
own.

## What Are Community Sandboxes

Community sandboxes are ready-to-use environments published in the
[Diffract Community](https://github.com/NVIDIA/Diffract-Community) repository.
...
| `diffraction` | Open agent manipulation and control |
...
[CONTRIBUTING.md](https://github.com/NVIDIA/Diffract-Community/blob/main/CONTRIBUTING.md)
