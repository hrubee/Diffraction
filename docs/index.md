---
title:
  page: NVIDIA Diffract Developer Guide
  nav: Get Started
  card: NVIDIA Diffract
...
[![GitHub](https://img.shields.io/badge/github-repo-green?logo=github)](https://github.com/NVIDIA/Diffract)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue)](https://github.com/NVIDIA/Diffract/blob/main/LICENSE)
[![PyPI](https://img.shields.io/badge/PyPI-diffract-orange?logo=pypi)](https://pypi.org/project/diffract/)

NVIDIA Diffract is the safe, private runtime for autonomous AI agents. It provides sandboxed execution environments
...
<div class="nc-term">
  ...
  <div class="nc-term-body">
    <div><span class="nc-ps">$ </span>uv tool install -U diffract</div>
    <div><span class="nc-ps">$ </span>diffract sandbox create <span class="nc-swap"><span>-- <span class="nc-hl">claude</span></span><span>--from <span class="nc-hl">diffraction</span></span><span>-- <span class="nc-hl">opencode</span></span><span>-- <span class="nc-hl">codex</span></span></span><span class="nc-cursor"></span></div>
  </div>
</div>
```
...
:::{grid-item-card} About Diffract
:link: about/overview
:link-type: doc

Learn about Diffract and its capabilities.
