...
export declare function detectHostDiffract(env?: NodeJS.ProcessEnv): HostDiffractState;
export declare function createSnapshotBundle(hostState: HostDiffractState, logger: PluginLogger, options: {
    persist: boolean;
}): SnapshotBundle | null;
