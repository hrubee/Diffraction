...
function isInsideSandbox() {
    return (0, node_fs_1.existsSync)("/sandbox/.diffract") || (0, node_fs_1.existsSync)("/sandbox/.nemoclaw");
}
async function cliStatus(opts) {
    ...
    if (state.migrationSnapshot) {
        ...
        logger.info("  Run 'diffract nemoclaw eject' to restore host installation.");
    }
}
