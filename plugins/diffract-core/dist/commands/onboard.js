...
function execDiffract(args) {
    return (0, node_child_process_1.execFileSync)("diffract", args, {
        encoding: "utf-8",
...
async function cliOnboard(opts) {
    ...
    logger.info("  diffract nemoclaw launch     # Bootstrap sandbox");
    logger.info("  diffract nemoclaw status     # Check configuration");
}
