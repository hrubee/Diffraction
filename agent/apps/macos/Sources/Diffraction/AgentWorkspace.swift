...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.diffraction", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return DiffractionConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - Diffraction Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.diffraction/diffraction.json
