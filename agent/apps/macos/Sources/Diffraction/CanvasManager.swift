...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.diffraction", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Diffraction/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__diffraction__/a2ui/").absoluteString + "?platform=macos"
    }
