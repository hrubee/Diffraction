...
enum DiffractionConfigFile {
    private static let logger = Logger(subsystem: "ai.diffraction", category: "config")
    ...
    static func stateDirURL() -> URL {
        DiffractionPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        DiffractionPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-diffraction-config-file",
            "event": "config.write",
