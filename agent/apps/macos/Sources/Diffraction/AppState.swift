...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = DiffractionConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = DiffractionConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: DiffractionConfigFile.loadDict(),
        ...
        DiffractionConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/diffraction"
        state.remoteCliPath = ""
        return state
    }
}
