...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.diffraction.mac.plist")
    }
    ...
    static func plistContents(bundlePath: String) -> String {
        ...
        <dict>
          <key>Label</key>
          <string>ai.diffraction.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/Diffraction</string>
          </array>
