...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .diffractionSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DiffractionPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DiffractionPaths.stateDirURL.path
...
extension Notification.Name {
    static let diffractionSelectSettingsTab = Notification.Name("diffractionSelectSettingsTab")
}
