...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.diffraction", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Diffraction windows, but below the system’s pop-up menus.
