...
/// Menu contents for the Diffraction menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Diffraction") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Diffraction Not Configured"
        case .remote:
            "Remote Diffraction Active"
        case .local:
            "Diffraction Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .diffractionSelectSettingsTab, object: tab)
        }
    }
