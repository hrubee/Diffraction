...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.diffraction", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".diffraction/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.diffractionCommand(
            subcommand: "gateway",
