...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/diffraction/diffraction") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/diffraction/diffraction")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://diffraction.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "DiffractionBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DiffractionBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "DiffractionGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DiffractionGitCommit") as? String) ??
            "unknown"
    }
