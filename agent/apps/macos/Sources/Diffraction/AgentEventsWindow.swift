...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: DiffractionProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": DiffractionProtocol.AnyCodable("start"),
                "name": DiffractionProtocol.AnyCodable("bash"),
            ],
            summary: nil)
