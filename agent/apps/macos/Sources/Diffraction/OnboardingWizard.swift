...
private let onboardingWizardLogger = Logger(subsystem: "ai.diffraction", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between DiffractionProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = DiffractionProtocol.AnyCodable
