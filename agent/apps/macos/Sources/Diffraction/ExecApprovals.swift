...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.diffraction", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        DiffractionPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        DiffractionPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
