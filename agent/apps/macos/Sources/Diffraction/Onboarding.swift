...
enum UIStrings {
    static let welcomeTitle = "Welcome to Diffraction"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "diffraction.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: DiffractionChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g diffraction@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: DiffractionChatViewModel(
