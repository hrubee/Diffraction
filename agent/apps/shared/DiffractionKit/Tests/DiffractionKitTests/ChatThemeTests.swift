...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = DiffractionChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = DiffractionChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
