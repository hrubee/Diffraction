...
public struct DiffractionChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct DiffractionChatSessionsDefaults: Codable, Sendable {
...
public struct DiffractionChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct DiffractionChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: DiffractionChatSessionsDefaults?
    public let sessions: [DiffractionChatSessionEntry]
    ...
    public init(
        ...
        sessions: [DiffractionChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
