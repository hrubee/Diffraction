...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: DiffractionProtocol.AnyCodable]?
    {
        ...
        return [
            "id": DiffractionProtocol.AnyCodable(identity.deviceId),
            "publicKey": DiffractionProtocol.AnyCodable(publicKey),
            "signature": DiffractionProtocol.AnyCodable(signature),
            "signedAt": DiffractionProtocol.AnyCodable(signedAtMs),
            "nonce": DiffractionProtocol.AnyCodable(nonce),
        ]
    }
}
