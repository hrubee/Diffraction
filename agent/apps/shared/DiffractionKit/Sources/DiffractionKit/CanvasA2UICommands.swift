...
public enum DiffractionCanvasA2UICommand: String, Codable, Sendable {
...
public struct DiffractionCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DiffractionCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
