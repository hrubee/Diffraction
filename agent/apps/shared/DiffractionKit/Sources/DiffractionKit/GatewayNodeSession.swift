...
private func replaceCanvasCapabilityInScopedHostUrl(scopedUrl: String, capability: String) -> String? {
    let marker = "/__diffraction__/cap/"
...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.diffraction", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.diffraction", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: DiffractionProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
