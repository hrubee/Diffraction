# fastlane setup (Diffraction iOS)
...
ASC_KEYCHAIN_SERVICE=diffraction-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.diffraction.client
# or
...
- The beta flow regenerates `apps/ios/Diffraction.xcodeproj` from `apps/ios/project.yml` before archiving
