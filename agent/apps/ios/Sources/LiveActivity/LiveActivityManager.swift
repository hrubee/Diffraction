...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.diffraction.ios", category: "LiveActivity")
    private var currentActivity: Activity<DiffractionActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = DiffractionActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<DiffractionActivityAttributes>.activities
    ...
    private func updateCurrent(state: DiffractionActivityAttributes.ContentState) {
    ...
    private func connectingState() -> DiffractionActivityAttributes.ContentState {
        DiffractionActivityAttributes.ContentState(
    ...
    private func idleState() -> DiffractionActivityAttributes.ContentState {
        DiffractionActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> DiffractionActivityAttributes.ContentState {
        DiffractionActivityAttributes.ContentState(
