...
extension NodeAppModel {
    func resolveCanvasHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__diffraction__/canvas/").absoluteString
    }
    ...
    func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__diffraction__/a2ui/").absoluteString + "?platform=ios"
    }
