...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.diffraction.gateway"
    private static let nodeService = "ai.diffraction.node"
    private static let talkService = "ai.diffraction.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.diffraction.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.diffraction.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("diffraction-gateway.log")
    }
