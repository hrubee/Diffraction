...
final class CalendarService: CalendarServicing {
    func events(params: DiffractionCalendarEventsParams) async throws -> DiffractionCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            DiffractionCalendarEventPayload(
        ...
        return DiffractionCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: DiffractionCalendarAddParams) async throws -> DiffractionCalendarAddPayload {
        ...
        let payload = DiffractionCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return DiffractionCalendarAddPayload(event: payload)
    }
