...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: DiffractionPhotosLatestParams) async throws -> DiffractionPhotosLatestPayload {
        ...
        var results: [DiffractionPhotoPayload] = []
        ...
        return DiffractionPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> DiffractionPhotoPayload
    {
        ...
        return DiffractionPhotoPayload(
            format: "jpeg",
