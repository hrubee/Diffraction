...
import ai.diffraction.app.ui.mobileAccentBorderStrong
...
import ai.diffraction.app.ui.mobileSurface
import ai.diffraction.app.ui.mobileText
import ai.diffraction.app.ui.mobileTextSecondary
import ai.diffraction.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.diffraction.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.diffraction.app.ui.mobileFontFamily,
