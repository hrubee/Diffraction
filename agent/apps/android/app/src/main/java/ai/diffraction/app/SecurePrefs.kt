...
class SecurePrefs(
  ...
  companion object {
    val defaultWakeWords: List<String> = listOf("diffraction", "claude")
    private const val displayNameKey = "node.displayName"
    private const val locationModeKey = "location.enabledMode"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "diffraction.node"
    private const val securePrefsName = "diffraction.node.secure"
  }
