    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Diffraction Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("diffraction qr --setup-code-only")
          CommandBlock("diffraction qr --json")
