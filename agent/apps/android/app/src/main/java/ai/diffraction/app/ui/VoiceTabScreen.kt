...
import ai.diffraction.app.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "Diffraction",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Diffraction is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
