...
object DiffractionCanvasA2UIAction {
  ...
  fun jsDispatchA2UIActionStatus(actionId: String, ok: Boolean, error: String?): String {
    ...
    return "window.dispatchEvent(new CustomEvent('diffraction:a2ui-action-status', { detail: { id: ${idLiteral}, ok: ${okLiteral}, error: ${err} } }));"
  }
