...
function normalizeDenyList(cfg: DiffractionPluginApi["config"]): string[] {
  return uniqSorted([...(cfg.gateway?.nodes?.denyCommands ?? [])]);
}

function normalizeAllowList(cfg: DiffractionPluginApi["config"]): string[] {
...
export default definePluginEntry({
  ...
  register(api: DiffractionPluginApi) {
    ...
    const timerService: DiffractionPluginService = {
