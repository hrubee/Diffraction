...
export function listWhatsAppAuthDirs(cfg: DiffractionConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DiffractionConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DiffractionConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DiffractionConfig): ResolvedWhatsAppAccount[] {
