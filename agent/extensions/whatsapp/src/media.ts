...
import { SafeOpenError, readLocalFileSafely } from "diffraction/plugin-sdk/infra-runtime";
import type { SsrFPolicy } from "diffraction/plugin-sdk/infra-runtime";
import { type MediaKind, maxBytesForKind } from "diffraction/plugin-sdk/media-runtime";
import { fetchRemoteMedia } from "diffraction/plugin-sdk/media-runtime";
import {
  convertHeicToJpeg,
  hasAlphaChannel,
  optimizeImageToPng,
...
import { getDefaultMediaLocalRoots } from "diffraction/plugin-sdk/media-runtime";
import { detectMime, extensionForMime, kindFromMime } from "diffraction/plugin-sdk/media-runtime";
import { logVerbose, shouldLogVerbose } from "diffraction/plugin-sdk/runtime-env";
import { resolveUserPath } from "diffraction/plugin-sdk/text-runtime";
...
async function assertLocalMediaAllowed(
  ...
  // Hardening: the default allowlist includes the Diffraction temp dir, and tests/CI may
