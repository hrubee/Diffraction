import type { ChannelSetupInput } from "diffraction/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "diffraction/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Diffraction" "<shared-secret>" "<webhook-url>" --feature reaction',
