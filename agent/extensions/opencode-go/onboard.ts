import { OPENCODE_GO_DEFAULT_MODEL_REF } from "diffraction/plugin-sdk/provider-models";
import {
...
export function applyOpencodeGoProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: DiffractionConfig): DiffractionConfig {
