...
export async function resolveTlonSetupConfigured(cfg: DiffractionConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: DiffractionConfig): Promise<string[]> {
