...
import { fetchWithSsrFGuard } from "diffraction/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Diffraction workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".diffraction", "workspace", "media", "inbound");
 ...
 * Format matches Diffraction's expected attachment structure.
 */
