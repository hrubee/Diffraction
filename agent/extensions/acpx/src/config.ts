...
import type { DiffractionPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "diffraction.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): DiffractionPluginConfigSchema {
  return {
