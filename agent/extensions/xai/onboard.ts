...
>({
  ...
  resolveParams: (_cfg: DiffractionConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-completions");
}

export function applyXaiResponsesApiConfig(cfg: DiffractionConfig): DiffractionConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: DiffractionConfig): DiffractionConfig {
