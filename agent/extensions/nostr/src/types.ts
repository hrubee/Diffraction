...
function resolveConfiguredDefaultNostrAccountId(cfg: DiffractionConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: DiffractionConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: DiffractionConfig): string {
