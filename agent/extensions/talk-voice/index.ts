import { resolveActiveTalkProviderConfig } from "diffraction/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "diffraction/plugin-sdk/speech";
import { definePluginEntry, type DiffractionPluginApi } from "./api.js";
