import { describeAccountSnapshot } from "diffraction/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "diffraction/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "diffraction/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "diffraction/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "diffraction/plugin-sdk/channel-contract";
import { createPairingPrefixStripper } from "diffraction/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigWarningCollector,
} from "diffraction/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "diffraction/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
  listDirectoryEntriesFromSources,
} from "diffraction/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "diffraction/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "diffraction/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "diffraction/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, DiffractionConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: DiffractionConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: DiffractionConfig }>(
