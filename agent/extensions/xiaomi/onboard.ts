...
export function applyXiaomiProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return xiaomiPresetAppliers.applyProviderConfig(cfg);
}

export function applyXiaomiConfig(cfg: DiffractionConfig): DiffractionConfig {
