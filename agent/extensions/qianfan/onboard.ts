...
function resolveQianfanPreset(cfg: DiffractionConfig): {
  api: ModelApi;
  baseUrl: string;
...
const qianfanPresetAppliers = createDefaultModelsPresetAppliers({
  ...
  resolveParams: (cfg: DiffractionConfig) => {
...
export function applyQianfanProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: DiffractionConfig): DiffractionConfig {
