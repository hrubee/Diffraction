...
import { parseDurationMs } from "diffraction/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
  type ProviderAuthContext,
  type ProviderResolveDynamicModelContext,
  type ProviderRuntimeModel,
} from "diffraction/plugin-sdk/plugin-entry";
import {
  ...
  validateApiKeyInput,
} from "diffraction/plugin-sdk/provider-auth";
import { normalizeModelCompat } from "diffraction/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "diffraction/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("diffraction doctor --yes")}"`,
  ].join("\n");
}
