...
import { createChannelPairingChallengeIssuer } from "diffraction/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "diffraction/plugin-sdk/channel-reply-pipeline";
import { loadConfig } from "diffraction/plugin-sdk/config-runtime";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "diffraction/plugin-sdk/config-runtime";
...
import { normalizeScpRemoteHost } from "diffraction/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "diffraction/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "diffraction/plugin-sdk/media-runtime";
import { kindFromMime } from "diffraction/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "diffraction/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "diffraction/plugin-sdk/reply-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "diffraction/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "diffraction/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T diffraction@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., diffraction@192.168.64.3)
