...
function mergeIMessageAccountConfig(cfg: DiffractionConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: DiffractionConfig): ResolvedIMessageAccount[] {
