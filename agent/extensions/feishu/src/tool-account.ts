...
import type { DiffractionPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: DiffractionPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<DiffractionPluginApi, "config">;
