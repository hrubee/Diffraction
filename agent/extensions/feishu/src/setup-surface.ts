...
function setFeishuGroupAllowFrom(cfg: DiffractionConfig, groupAllowFrom: string[]): DiffractionConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function isFeishuConfigured(cfg: DiffractionConfig): boolean {
