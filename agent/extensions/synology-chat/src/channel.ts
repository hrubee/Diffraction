/**
 * Synology Chat Channel Plugin for Diffraction.
 *
...
import { createChatChannelPlugin, type ChannelPlugin } from "diffraction/plugin-sdk/core";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "diffraction pairing approve synology-chat <code>",
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Diffraction",
        order: 90,
      },
      capabilities: {
