...
vi.mock("diffraction/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("diffraction/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("diffraction/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("diffraction/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("diffraction/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("diffraction/plugin-sdk/webhook-ingress");
  return {
    ...actual,
