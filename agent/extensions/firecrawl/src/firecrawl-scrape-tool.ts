...
import { jsonResult, readNumberParam, readStringParam } from "diffraction/plugin-sdk/agent-runtime";
...
export function createFirecrawlScrapeTool(api: DiffractionPluginApi) {
  return {
