import { markdownToText, truncateText } from "diffraction/plugin-sdk/agent-runtime";
...
import { wrapExternalContent, wrapWebContent } from "diffraction/plugin-sdk/security-runtime";
import {
