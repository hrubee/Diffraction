...
import type { DiffractionConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
async function runLogoutScenario(params: { cfg: DiffractionConfig; accountId: string }): Promise<{
