...
} from "diffraction/plugin-sdk/account-id";
import type { DiffractionConfig } from "diffraction/plugin-sdk/account-resolution";
import { resolveAccountEntry } from "diffraction/plugin-sdk/account-resolution";
...
export function listLineAccountIds(cfg: DiffractionConfig): string[] {
  const lineConfig = cfg.channels?.line as LineConfig | undefined;
  const accounts = lineConfig?.accounts;
...
export function resolveDefaultLineAccountId(cfg: DiffractionConfig): string {
