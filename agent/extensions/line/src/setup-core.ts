import type { ChannelSetupAdapter, DiffractionConfig } from "diffraction/plugin-sdk/setup";
import {
  DEFAULT_ACCOUNT_ID,
  listLineAccountIds,
  normalizeAccountId,
...
export function isLineConfigured(cfg: DiffractionConfig, accountId: string): boolean {
