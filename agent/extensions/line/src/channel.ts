...
import { createEmptyChannelDirectoryAdapter } from "diffraction/plugin-sdk/directory-runtime";
import { resolveOutboundMediaUrls } from "diffraction/plugin-sdk/reply-payload";
import {
...
const lineSecurityAdapter = createRestrictSendersChannelSecurity<ResolvedLineAccount>({
  ...
  approveHint: "diffraction pairing approve line <code>",
