...
import { createAccountStatusSink } from "diffraction/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "diffraction/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "diffraction/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "diffraction/plugin-sdk/conversation-runtime";
import { createChatChannelPlugin } from "diffraction/plugin-sdk/core";
import { buildPassiveProbedChannelStatusSummary } from "diffraction/plugin-sdk/extension-shared";
import {
...
function resolveZalouserOutboundChunkMode(cfg: DiffractionConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: DiffractionConfig, accountId?: string) {
