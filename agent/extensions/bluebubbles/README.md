...
This directory contains the **BlueBubbles external channel plugin** for Diffraction.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `diffraction/plugin-sdk` helpers.
