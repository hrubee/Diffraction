...
import { resolveChannelMediaMaxBytes, type DiffractionConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: DiffractionConfig; accountId?: string }): string[] {
