 ...
 */
export function applyChutesProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
 ...
 */
export function applyChutesConfig(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyChutesApiKeyConfig(cfg: DiffractionConfig): DiffractionConfig {
