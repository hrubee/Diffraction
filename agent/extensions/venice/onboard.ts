...
export function applyVeniceProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return venicePresetAppliers.applyProviderConfig(cfg);
}

export function applyVeniceConfig(cfg: DiffractionConfig): DiffractionConfig {
