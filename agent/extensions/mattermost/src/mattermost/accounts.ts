...
import { createAccountListHelpers, type DiffractionConfig } from "../runtime-api.js";
...
export function listEnabledMattermostAccounts(cfg: DiffractionConfig): ResolvedMattermostAccount[] {
