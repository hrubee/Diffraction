...
import { formatNormalizedAllowFromEntries } from "diffraction/plugin-sdk/allow-from";
import { createMessageToolButtonsSchema } from "diffraction/plugin-sdk/channel-actions";
import {
...
import { createLoggedPairingApprovalNotifier } from "diffraction/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "diffraction/plugin-sdk/channel-policy";
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "Diffraction: your access has been approved.",
