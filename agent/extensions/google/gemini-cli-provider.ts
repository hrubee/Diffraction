...
import { fetchGeminiUsage } from "diffraction/plugin-sdk/provider-usage";
...
const ENV_VARS = [
  "DIFFRACTION_GEMINI_OAUTH_CLIENT_ID",
  "DIFFRACTION_GEMINI_OAUTH_CLIENT_SECRET",
...
export function registerGoogleGeminiCliProvider(api: DiffractionPluginApi) {
