...
import type { DiffractionPluginConfigSchema } from "diffraction/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): DiffractionPluginConfigSchema {
