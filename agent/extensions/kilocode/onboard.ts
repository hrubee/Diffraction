import { KILOCODE_BASE_URL, KILOCODE_DEFAULT_MODEL_REF } from "diffraction/plugin-sdk/provider-models";
import {
...
export function applyKilocodeProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return kilocodePresetAppliers.applyProviderConfig(cfg);
}

export function applyKilocodeConfig(cfg: DiffractionConfig): DiffractionConfig {
