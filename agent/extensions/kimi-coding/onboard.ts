...
export function applyKimiCodeProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
  return kimiCodingPresetAppliers.applyProviderConfig(cfg);
}

export function applyKimiCodeConfig(cfg: DiffractionConfig): DiffractionConfig {
