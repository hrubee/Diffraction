...
import { loadConfig, type DiffractionConfig } from "diffraction/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "diffraction/plugin-sdk/media-runtime";
import { extensionForMime } from "diffraction/plugin-sdk/media-runtime";
import { unlinkIfExists } from "diffraction/plugin-sdk/media-runtime";
import type { PollInput } from "diffraction/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "diffraction/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredDiffractionTmpDir();
