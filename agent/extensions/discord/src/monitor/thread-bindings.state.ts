...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "diffraction/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("diffraction.discordThreadBindingsState");
