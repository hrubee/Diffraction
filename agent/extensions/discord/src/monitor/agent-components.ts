...
import { resolveHumanDelayConfig } from "diffraction/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "diffraction/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "diffraction/plugin-sdk/channel-reply-pipeline";
import type { DiffractionConfig } from "diffraction/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "diffraction/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "diffraction/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "diffraction/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "diffraction/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "diffraction/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "diffraction/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "diffraction/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "diffraction/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "diffraction/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "diffraction/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "diffraction/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "diffraction/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "diffraction/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "diffraction/plugin-sdk/routing";
import { logVerbose } from "diffraction/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "diffraction/plugin-sdk/runtime-env";
import { logDebug, logError } from "diffraction/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__diffraction_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__diffraction_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__diffraction_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__diffraction_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__diffraction_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__diffraction_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Diffraction form";
  customId = "__diffraction_discord_component_modal_wildcard__";
  components = [];
