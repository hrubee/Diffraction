...
import { buildPluginBindingApprovalCustomId } from "diffraction/plugin-sdk/conversation-runtime";
...
vi.mock("diffraction/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/security-runtime")>();
  return {
    ...actual,
...
vi.mock("diffraction/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("diffraction/plugin-sdk/conversation-runtime.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/conversation-runtime")>();
  return {
    ...actual,
    upsertChannelPairingRequest: (...args: unknown[]) => upsertPairingRequestMock(...args),
...
vi.mock("diffraction/plugin-sdk/infra-runtime", async (importOriginal) => {
...
vi.mock("diffraction/plugin-sdk/infra-runtime.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/infra-runtime")>();
  return {
    ...actual,
    enqueueSystemEvent: (...args: unknown[]) => enqueueSystemEventMock(...args),
...
vi.mock("diffraction/plugin-sdk/reply-runtime", async (importOriginal) => {
...
vi.mock("diffraction/plugin-sdk/config-runtime", async (importOriginal) => {
...
vi.mock("diffraction/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): DiffractionConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/diffraction-sessions-test.json");
    ...
    resolvePluginConversationBindingApprovalMock.mockReset().mockResolvedValue({
      ...
      binding: {
        ...
        pluginName: "Diffraction App Server",
