...
export type DiscordConfig = NonNullable<DiffractionConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("diffraction/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "diffraction-bot",
