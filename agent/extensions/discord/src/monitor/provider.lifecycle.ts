...
import { createArmableStallWatchdog } from "diffraction/plugin-sdk/channel-lifecycle";
import { createConnectedChannelStatusPatch } from "diffraction/plugin-sdk/gateway-runtime";
import { danger } from "diffraction/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before Diffraction can
