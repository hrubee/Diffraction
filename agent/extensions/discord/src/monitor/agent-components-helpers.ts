...
import { resolveCommandAuthorizedFromAuthorizers } from "diffraction/plugin-sdk/command-auth";
...
import { upsertChannelPairingRequest } from "diffraction/plugin-sdk/conversation-runtime";
...
import { logError } from "diffraction/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("diffraction/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
