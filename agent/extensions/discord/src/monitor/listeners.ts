...
import { formatDurationSeconds } from "diffraction/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("diffraction/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("diffraction/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("diffraction/plugin-sdk/runtime-env").createSubsystemLogger>;
