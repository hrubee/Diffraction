...
} from "diffraction/plugin-sdk/command-auth";
import {
...
import type { DiffractionConfig, loadConfig } from "diffraction/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "diffraction/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "diffraction/plugin-sdk/config-runtime";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "diffraction/plugin-sdk/conversation-runtime";
import { buildPairingReply } from "diffraction/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "diffraction/plugin-sdk/media-runtime";
import { executePluginCommand, matchPluginCommand } from "diffraction/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "diffraction/plugin-sdk/reply-payload";
import { resolveChunkMode, resolveTextChunkLimit } from "diffraction/plugin-sdk/reply-runtime";
import { dispatchReplyWithDispatcher } from "diffraction/plugin-sdk/reply-runtime";
...
import { createSubsystemLogger } from "diffraction/plugin-sdk/runtime-env";
import { loadWebMedia } from "diffraction/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<DiffractionConfig["channels"]>["discord"];
