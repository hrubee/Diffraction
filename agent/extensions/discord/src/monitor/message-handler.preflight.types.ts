...
import type { SessionBindingRecord } from "diffraction/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "diffraction/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "diffraction/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("diffraction/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("diffraction/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("diffraction/plugin-sdk/config-runtime").DiffractionConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
