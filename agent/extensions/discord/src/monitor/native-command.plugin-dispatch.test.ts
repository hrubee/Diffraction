...
import type { DiffractionConfig } from "../../../../src/config/config.js";
...
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("diffraction/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
function createConfig(): DiffractionConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: DiffractionConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: DiffractionConfig; name: string }) {
  const createDiscordNativeCommand = await loadCreateDiscordNativeCommand();
  return createDiscordNativeCommand({
    command: {
      name: params.name,
...
async function createStatusCommand(cfg: DiffractionConfig) {
...
describe("Discord native plugin command dispatch", () => {
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("diffraction/plugin-sdk/plugin-runtime")
    >("diffraction/plugin-sdk/plugin-runtime");
