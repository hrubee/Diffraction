...
import type { DiffractionConfig, ReplyToMode } from "diffraction/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "diffraction/plugin-sdk/plugin-runtime";
...
import {
  ...
  shouldLogVerbose,
  warn,
} from "diffraction/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "diffraction/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("diffraction/plugin-sdk/reply-history").HistoryEntry[]
    >();
