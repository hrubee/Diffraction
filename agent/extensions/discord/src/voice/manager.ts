...
import { resolveAgentDir } from "diffraction/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "diffraction/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "diffraction/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "diffraction/plugin-sdk/config-runtime";
import { formatErrorMessage } from "diffraction/plugin-sdk/infra-runtime";
import { resolvePreferredDiffractionTmpDir } from "diffraction/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "diffraction/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "diffraction/plugin-sdk/speech";
import { textToSpeech } from "diffraction/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: DiffractionConfig; override?: TtsConfig }): {
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredDiffractionTmpDir(), "discord-voice-"));
