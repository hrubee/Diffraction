...
import { normalizeAccountId } from "diffraction/plugin-sdk/account-id";
import { resolveAccountEntry } from "diffraction/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, DiffractionConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: DiffractionConfig): ResolvedDiscordAccount[] {
