...
import { OLLAMA_DEFAULT_BASE_URL, resolveOllamaApiBase } from "diffraction/plugin-sdk/provider-models";

const PROVIDER_ID = "ollama";
const DEFAULT_API_KEY = "ollama-local";

async function loadProviderSetup() {
  return await import("diffraction/plugin-sdk/ollama-setup");
}
