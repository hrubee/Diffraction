...
import { isSecretRef, type DiffractionConfig } from "diffraction/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: DiffractionConfig): ResolvedGoogleChatAccount[] {
