import { createActionGate } from "diffraction/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "diffraction/plugin-sdk/channel-contract";
import type { DiffractionConfig } from "diffraction/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "diffraction/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: DiffractionConfig): ChannelMessageActionName[] {
