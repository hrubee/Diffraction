...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): DiffractionConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: DiffractionConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: DiffractionConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
