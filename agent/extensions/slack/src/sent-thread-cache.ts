import { resolveGlobalDedupeCache } from "diffraction/plugin-sdk/infra-runtime";
 ...
 */
const SLACK_THREAD_PARTICIPATION_KEY = Symbol.for("diffraction.slackThreadParticipation");
