...
import { type ChatCommandDefinition, type CommandArgs } from "diffraction/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "diffraction/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "diffraction_cmdarg";
