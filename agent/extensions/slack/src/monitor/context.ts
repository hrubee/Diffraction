...
import { resolveSessionKey, type SessionScope } from "diffraction/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "diffraction/plugin-sdk/config-runtime";
import { createDedupeCache } from "diffraction/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "diffraction/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("diffraction/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
