...
type BuildCommandTextFromArgs =
  typeof import("diffraction/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("diffraction/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("diffraction/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("diffraction/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("diffraction/plugin-sdk/command-auth").resolveCommandArgMenu;
