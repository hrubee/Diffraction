...
import { createChannelPluginBase } from "diffraction/plugin-sdk/core";
import {
  formatDocsLink,
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Diffraction";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Diffraction`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Diffraction"): string[] {
  return [
