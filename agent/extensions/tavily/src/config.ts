...
export function resolveTavilySearchConfig(cfg?: DiffractionConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: DiffractionConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: DiffractionConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
