...
vi.mock("diffraction/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/diffraction-sessions.json"),
...
vi.mock("diffraction/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("diffraction/plugin-sdk/conversation-runtime")>(
    "diffraction/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("diffraction/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("diffraction/plugin-sdk/security-runtime")>(
    "diffraction/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("diffraction/plugin-sdk/reply-runtime"),
      import("diffraction/plugin-sdk/infra-runtime"),
    ]);
    resetInboundDedupe();
    config = {
