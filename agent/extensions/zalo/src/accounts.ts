...
function mergeZaloAccountConfig(cfg: DiffractionConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: DiffractionConfig): ResolvedZaloAccount[] {
