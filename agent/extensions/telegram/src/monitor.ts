...
import { resolveAgentMaxConcurrent } from "diffraction/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "diffraction/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: DiffractionConfig): RunOptions<unknown> {
  return {
    sink: {
