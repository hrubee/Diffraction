...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "diffraction/plugin-sdk/agent-runtime";
...
import { clearHistoryEntriesIfEnabled } from "diffraction/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "diffraction/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: DiffractionConfig, agentId: string) {
  try {
