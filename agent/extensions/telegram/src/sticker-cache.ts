...
import { resolveApiKeyForProvider } from "diffraction/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "diffraction/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "diffraction/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "diffraction/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "diffraction/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "diffraction/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "diffraction/plugin-sdk/runtime-env";
import { STATE_DIR } from "diffraction/plugin-sdk/state-paths";
