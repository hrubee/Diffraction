...
import type { GetReplyOptions, MsgContext } from "diffraction/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("diffraction/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as DiffractionConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("diffraction/plugin-sdk/media-runtime")>,
) {
...
vi.mock("diffraction/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("diffraction/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
