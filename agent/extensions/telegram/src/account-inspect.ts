import { resolveAccountWithDefaultFallback } from "diffraction/plugin-sdk/account-resolution";
import type { DiffractionConfig } from "diffraction/plugin-sdk/config-runtime";
import { coerceSecretRef } from "diffraction/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "diffraction/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "diffraction/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "diffraction/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: DiffractionConfig; value: unknown }): {
  token: string;
