...
import { GatewayClient } from "diffraction/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "diffraction/plugin-sdk/gateway-runtime";
import type { EventFrame } from "diffraction/plugin-sdk/gateway-runtime";
import { resolveExecApprovalCommandDisplay } from "diffraction/plugin-sdk/infra-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  type ExecApprovalPendingReplyParams,
} from "diffraction/plugin-sdk/infra-runtime";
import { resolveExecApprovalSessionTarget } from "diffraction/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "diffraction/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "diffraction/plugin-sdk/routing";
...
import { compileSafeRegex, testRegexWithBoundedInput } from "diffraction/plugin-sdk/security-runtime";
...
function isHandlerConfigured(params: { cfg: DiffractionConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
