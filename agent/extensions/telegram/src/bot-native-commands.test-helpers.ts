...
import type { ChannelGroupPolicy } from "diffraction/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "diffraction/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("diffraction/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("diffraction/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("diffraction/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("diffraction/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("diffraction/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("diffraction/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("diffraction/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as DiffractionConfig)),
