...
import { danger, logVerbose } from "diffraction/plugin-sdk/runtime-env";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): DiffractionConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: DiffractionConfig): TelegramAccountConfig => {
    try {
