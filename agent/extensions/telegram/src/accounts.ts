...
} from "diffraction/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "diffraction/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "diffraction/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "diffraction/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.DIFFRACTION_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: DiffractionConfig): string[] {
...
export function listTelegramAccountIds(cfg: DiffractionConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: DiffractionConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/diffraction/diffraction/issues/30673
...
export function listEnabledTelegramAccounts(cfg: DiffractionConfig): ResolvedTelegramAccount[] {
