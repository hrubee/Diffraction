...
function createCfg(): DiffractionConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: DiffractionConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: DiffractionConfig, accountId: string) {
...
function startTelegramAccount(cfg: DiffractionConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: DiffractionConfig) {
