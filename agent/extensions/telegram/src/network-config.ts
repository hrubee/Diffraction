...
import type { TelegramNetworkConfig } from "diffraction/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "diffraction/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "diffraction/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "DIFFRACTION_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "DIFFRACTION_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "DIFFRACTION_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable DIFFRACTION_TELEGRAM_DNS_RESULT_ORDER
