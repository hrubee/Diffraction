...
type ResolveConfiguredBindingRouteFn =
  typeof import("diffraction/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
vi.mock("diffraction/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/diffraction-sessions.json");
