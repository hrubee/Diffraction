...
import { createFinalizableDraftLifecycle } from "diffraction/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("diffraction.telegramDraftStreamState");
