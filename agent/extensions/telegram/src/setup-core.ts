...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "diffraction/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://diffraction.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("diffraction logs --follow")}\` (safest)`,
