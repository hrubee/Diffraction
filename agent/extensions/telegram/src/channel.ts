...
} from "diffraction/plugin-sdk/allowlist-config-edit";
import { createPairingPrefixStripper } from "diffraction/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "diffraction/plugin-sdk/channel-policy";
import { attachChannelToResult } from "diffraction/plugin-sdk/channel-send-result";
import { createChatChannelPlugin } from "diffraction/plugin-sdk/core";
import { createChannelDirectoryAdapter } from "diffraction/plugin-sdk/directory-runtime";
import { resolveExecApprovalCommandDisplay } from "diffraction/plugin-sdk/infra-runtime";
import { buildExecApprovalPendingReplyPayload } from "diffraction/plugin-sdk/infra-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "diffraction/plugin-sdk/outbound-runtime";
import {
...
function hasTelegramExecApprovalDmRoute(cfg: DiffractionConfig): boolean {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as DiffractionConfig;
