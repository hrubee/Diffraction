import { createScopedExpiringIdCache, resolveGlobalMap } from "diffraction/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("diffraction.telegramSentMessages");
