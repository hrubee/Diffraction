import { definePluginEntry, type DiffractionConfig, type DiffractionPluginApi } from "./api.js";
...
function resolveOwnershipAgent(config: DiffractionConfig): { id: string; name: string } {
