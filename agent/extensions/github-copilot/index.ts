import { ensureAuthProfileStore, listProfilesForProvider } from "diffraction/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "diffraction/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "diffraction/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "diffraction/plugin-sdk/provider-auth-login";
