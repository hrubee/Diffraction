...
- 生成的 Swift 模型：`apps/macos/Sources/DiffractionProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/diffraction/diffraction/main/dist/protocol.schema.json
