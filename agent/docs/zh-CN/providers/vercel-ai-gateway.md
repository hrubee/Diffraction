---
read_when:
  - 你想将 Vercel AI Gateway 与 Diffraction 一起使用
...
- Diffraction 会自动发现 Gateway 的 `/v1/models` 目录，因此 `/models vercel-ai-gateway`
...
Diffraction 接受 Vercel Claude 简写模型引用，并会在运行时将其规范化：
