...
summary: 在 Diffraction 中使用 Synthetic 的 Anthropic 兼容 API
title: Synthetic
x-i18n:
...
Synthetic 提供与 Anthropic 兼容的端点。Diffraction 将其注册为
...
注意：Diffraction 的 Anthropic 客户端会将 `/v1` 追加到 base URL 后面，因此请使用
