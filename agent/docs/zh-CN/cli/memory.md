...
read_when:
  - 你想要索引或搜索语义记忆
  - 你正在调试记忆可用性或索引问题
summary: "`diffraction memory`（status/index/search）的 CLI 参考"
title: memory
x-i18n:
...
diffraction memory index
diffraction memory index --verbose
diffraction memory search "release checklist"
