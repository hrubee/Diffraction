...
本指南总结了在 Diffraction 中开发 Pi 集成的合理工作流程。
...
状态存储在 Diffraction 状态目录下。默认为 `~/.diffraction`。如果设置了 `DIFFRACTION_STATE_DIR`，则使用该目录。

要重置所有内容：

- `diffraction.json` 用于配置
...
- https://docs.diffraction.ai/testing
- https://docs.diffraction.ai/start/getting-started
