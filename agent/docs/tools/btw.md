...
It is modeled after Claude Code's `/btw` behavior, but adapted to Diffraction's
...
If the main run is currently active, Diffraction snapshots the current message
