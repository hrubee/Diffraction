...
- Artifacts are stored under the temp subfolder: `$TMPDIR/diffraction-diffs`.
...
1. `browser.executablePath` in Diffraction config.
2. Environment variables:
   - `DIFFRACTION_BROWSER_EXECUTABLE_PATH`
