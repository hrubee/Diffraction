...
Deepgram is a speech-to-text API. In Diffraction it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Diffraction uploads the audio file to Deepgram and injects the transcript
