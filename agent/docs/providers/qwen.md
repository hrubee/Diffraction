---
summary: "Use Qwen OAuth (free tier) in Diffraction"
read_when:
  - You want to use Qwen with Diffraction
...
If you already logged in with the Qwen Code CLI, Diffraction will sync credentials
