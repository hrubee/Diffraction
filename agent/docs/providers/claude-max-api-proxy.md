...
You can point Diffraction at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Diffraction
...
- [Anthropic provider](/providers/anthropic) - Native Diffraction integration with Claude setup-token or API keys
