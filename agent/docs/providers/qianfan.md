---
summary: "Use Qianfan's unified API to access many models in Diffraction"
read_when:
...
3. Diffraction installed on your system
...
4. Copy the API key for use with Diffraction

## CLI setup

```bash
diffraction onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Diffraction Configuration](/gateway/configuration)
