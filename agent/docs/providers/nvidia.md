---
summary: "Use NVIDIA's OpenAI-compatible API in Diffraction"
read_when:
  - You want to use NVIDIA models in Diffraction
...
diffraction onboard --auth-choice skip
diffraction models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
