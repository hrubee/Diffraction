---
summary: "Use Xiaomi MiMo models with Diffraction"
read_when:
  - You want Xiaomi MiMo models in Diffraction
...
Xiaomi MiMo is the API platform for **MiMo** models. Diffraction uses the Xiaomi
...
```bash
diffraction onboard --auth-choice xiaomi-api-key
# or non-interactive
diffraction onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
