...
summary: "Diffraction threat model mapped to the MITRE ATLAS framework"
read_when:
  - Reviewing security posture or threat scenarios
  - Working on security features or audit responses
---

# Diffraction Threat Model v1.0
...
This is a living document maintained by the Diffraction community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the Diffraction AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| Diffraction Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed Diffraction gateway endpoints                |
...
| **Affected Components** | ~/.diffraction/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | Diffraction Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | Diffraction's skill marketplace                              |
| **Gateway**          | Diffraction's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Diffraction agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@diffraction.ai_
