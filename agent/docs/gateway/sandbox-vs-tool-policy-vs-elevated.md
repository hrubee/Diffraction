...
Diffraction has three related (but different) controls:
...
Use the inspector to see what Diffraction is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:diffraction`: all built-in Diffraction tools (excludes provider plugins)
