...
Diffraction treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.diffraction/settings/voicewake.json`

Shape:

```json
{ "triggers": ["diffraction", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
