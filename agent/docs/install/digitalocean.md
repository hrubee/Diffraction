---
summary: "Host Diffraction on a DigitalOcean Droplet"
read_when:
  - Setting up Diffraction on DigitalOcean
  - Looking for a simple paid VPS for Diffraction
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Diffraction Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `diffraction doctor --non-interactive` and check logs with `journalctl --user -u diffraction-gateway.service -n 50`.
