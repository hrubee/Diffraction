---
summary: "Install Diffraction — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs Diffraction, and launches onboarding.
...
Or skip the link and use `pnpm diffraction ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
diffraction --version      # confirm the CLI is available
diffraction doctor         # check for config issues
diffraction gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy Diffraction on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove Diffraction completely.
  </Card>
</CardGroup>

## Troubleshooting: `diffraction` not found

If the install succeeded but `diffraction` is not found in your terminal:
