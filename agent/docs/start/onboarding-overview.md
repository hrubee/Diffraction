---
summary: "Overview of Diffraction onboarding options and flows"
read_when:
...
Diffraction has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `diffraction onboard`                     | Launch the app            |
...
CLI command docs: [`diffraction onboard`](/cli/onboard)

## macOS app onboarding

Open the Diffraction app. The first-run wizard walks you through the same steps
