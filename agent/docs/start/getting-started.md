---
summary: "Get Diffraction installed and run your first chat in minutes."
read_when:
...
Install Diffraction, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Diffraction as a service account or want custom paths:

- `DIFFRACTION_HOME` — home directory for internal path resolution
- `DIFFRACTION_STATE_DIR` — override the state directory
- `DIFFRACTION_CONFIG_PATH` — override the config file path
