---
summary: "Hubs that link to every Diffraction doc"
read_when:
...
<Note>
If you are new to Diffraction, start with [Getting Started](/start/getting-started).
</Note>
...
- [Diffraction assistant](/start/diffraction)
