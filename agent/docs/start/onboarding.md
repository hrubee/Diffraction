---
summary: "First-run setup flow for Diffraction (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Diffraction">
...
<Step title="CLI">
  ...
  The app can install the global `diffraction` CLI via npm/pnpm so terminal
