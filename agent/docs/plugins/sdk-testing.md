...
summary: "Testing utilities and patterns for Diffraction plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Diffraction
plugins.
...
**Import:** `diffraction/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "diffraction/plugin-sdk/testing";
...
import type { PluginRuntime } from "diffraction/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `diffraction/plugin-sdk` root barrel is rejected
...
Diffraction uses Vitest with V8 coverage thresholds. For plugin tests:
