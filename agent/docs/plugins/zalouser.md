...
read_when:
  - You want Zalo Personal (unofficial) support in Diffraction
...
Zalo Personal support for Diffraction via a plugin, using native `zca-js` to automate a normal Zalo user account.
