...
- Install via CLI: `diffraction plugins install @diffraction/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `diffraction plugins install ./extensions/zalo`
   - From npm (if published): `diffraction plugins install @diffraction/zalo`
...
This page reflects current Diffraction behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `diffraction pairing list zalo`
  - `diffraction pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Diffraction.
...
- Example: `diffraction message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `diffraction channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `diffraction logs --follow`
