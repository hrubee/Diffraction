...
Diffraction treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Diffraction “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Diffraction can see that group and respond there.
...
Translation: allowlisted senders can trigger Diffraction by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@diffraction", "diffraction", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
