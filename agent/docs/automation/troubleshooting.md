...
diffraction system heartbeat last
diffraction logs --follow
diffraction config get agents.defaults.heartbeat
diffraction channels status --probe
```
...
```bash
diffraction config get agents.defaults.heartbeat.activeHours
diffraction config get agents.defaults.heartbeat.activeHours.timezone
diffraction config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
diffraction cron list
diffraction logs --follow
```
