...
read_when:
  ...
  - Wiring external systems into Diffraction
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Diffraction config directory (typically `~/.diffraction/hooks/transforms`).
...
- `diffraction webhooks gmail setup` writes `hooks.gmail` config for `diffraction webhooks gmail run`.
