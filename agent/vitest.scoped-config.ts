...
export function resolveVitestIsolation(
  ...
  const forceIsolation = env.DIFFRACTION_TEST_ISOLATE === "1" || env.DIFFRACTION_TEST_ISOLATE === "true";
  if (forceIsolation) {
    return true;
  }
  return env.DIFFRACTION_TEST_NO_ISOLATE === "0" || env.DIFFRACTION_TEST_NO_ISOLATE === "false";
}
