    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["diffraction channels list", "List configured channels and auth profiles."],
          ["diffraction channels status --probe", "Run channel status checks and probes."],
          [
            "diffraction channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["diffraction channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.diffraction.ai/cli/channels",
        )}\n`,
    );
