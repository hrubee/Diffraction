    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["diffraction directory self --channel slack", "Show the connected account identity."],
          [
            'diffraction directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["diffraction directory groups list --channel discord", "List available groups/channels."],
          [
            "diffraction directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.diffraction.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
