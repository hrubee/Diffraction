      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["diffraction gateway run", "Run the gateway in the foreground."],
            ["diffraction gateway status", "Show service status and probe reachability."],
            ["diffraction gateway discover", "Find local and wide-area gateway beacons."],
            ["diffraction gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.diffraction.ai/cli/gateway")}\n`,
      ),
  );
