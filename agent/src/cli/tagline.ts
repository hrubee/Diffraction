const DEFAULT_TAGLINE = "All your chats, one Diffract.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little agent-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a workflow: messy, delicious, effective.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only agent in your contacts you actually want to hear from. 🔷",
  ...
  "Built by prisms, for humans. Don't question the hierarchy.",
  ...
  "Half butler, half debugger, fully sandboxed.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.DIFFRACTION_TAGLINE_INDEX;
