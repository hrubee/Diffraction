...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.DIFFRACTION_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.DIFFRACTION_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.DIFFRACTION_SERVICE_MARKER = originalServiceMarker;
    }
  });
