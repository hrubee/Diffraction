...
const hoisted = vi.hoisted(() => ({
  ...
  ensureDiffractionModelsJsonMock: vi.fn(async () => {}),
...
const {
  ...
  ensureDiffractionModelsJsonMock,
...
vi.mock("../agents/models-config.js", () => ({
  ensureDiffractionModelsJson: ensureDiffractionModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    const result = await describeImageWithModel({
      cfg: {},
      agentDir: "/tmp/diffraction-agent",
      provider: "minimax-portal",
      model: "MiniMax-VL-01",
    ...
    expect(ensureDiffractionModelsJsonMock).toHaveBeenCalled();
