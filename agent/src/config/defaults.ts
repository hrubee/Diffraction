...
function resolveAnthropicDefaultAuthMode(cfg: DiffractionConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyTalkApiKey(config: DiffractionConfig): DiffractionConfig {
...
export function applyTalkConfigNormalization(config: DiffractionConfig): DiffractionConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: DiffractionConfig): DiffractionConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyLoggingDefaults(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyContextPruningDefaults(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyCompactionDefaults(cfg: DiffractionConfig): DiffractionConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
