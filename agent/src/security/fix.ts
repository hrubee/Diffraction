...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DiffractionConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DiffractionConfig; env: NodeJS.ProcessEnv }): {
  cfg: DiffractionConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
