...
export const normalizePluginsConfig = (
  config?: DiffractionConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: DiffractionConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: DiffractionConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

export const hasExplicitPluginConfig = (plugins?: DiffractionConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
