...
export const PLUGIN_MANIFEST_FILENAME = "diffraction.plugin.json";
...
// package.json "diffraction" metadata (used for setup/catalog)
...
export type DiffractionPackageStartup = {
  /**
...
export type DiffractionPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: DiffractionPackageStartup;
};
...
): DiffractionPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
