...
export function applyGoogleGeminiModelDefault(cfg: DiffractionConfig): {
...
export function applyOpenAIProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyOpenAIConfig(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyOpencodeGoModelDefault(cfg: DiffractionConfig): {
  next: DiffractionConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: DiffractionConfig): {
  next: DiffractionConfig;
  changed: boolean;
} {
