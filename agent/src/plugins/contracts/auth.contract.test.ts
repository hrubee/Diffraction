...
import type { DiffractionPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("diffraction/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("diffraction/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("diffraction/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("diffraction/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("diffraction/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("diffraction/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("diffraction/plugin-sdk/agent-runtime", async (importOriginal) => {
...
function registerProviders(...plugins: Array<{ register(api: DiffractionPluginApi): void }>) {
