...
describe("provider discovery contract", () => {
  beforeAll(async () => {
    vi.doMock("diffraction/plugin-sdk/agent-runtime", async () => {
    ...
    vi.doMock("diffraction/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<object>("diffraction/plugin-sdk/provider-auth");
      return {
        ...actual,
        ensureAuthProfileStore: ensureAuthProfileStoreMock,
        listProfilesForProvider: listProfilesForProviderMock,
    ...
    vi.doMock("diffraction/plugin-sdk/provider-setup", async () => {
      const actual = await vi.importActual<object>("diffraction/plugin-sdk/provider-setup");
      return {
        ...actual,
    ...
    vi.doMock("diffraction/plugin-sdk/self-hosted-provider-setup", async () => {
      const actual = await vi.importActual<object>(
        "diffraction/plugin-sdk/self-hosted-provider-setup",
      );
      return {
        ...actual,
        buildVllmProvider: (...args: unknown[]) => buildVllmProviderMock(...args),
    ...
    vi.doMock("diffraction/plugin-sdk/ollama-setup", async () => {
      const actual = await vi.importActual<object>("diffraction/plugin-sdk/ollama-setup");
      return {
        ...actual,
        buildOllamaProvider: (...args: unknown[]) => buildOllamaProviderMock(...args),
      };
