...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: DiffractionConfig, ...args: TArgs) => DiffractionConfig;
  applyConfig: (cfg: DiffractionConfig, ...args: TArgs) => DiffractionConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: DiffractionConfig, preset: TParams) => DiffractionConfig;
  primaryModelRef: string;
