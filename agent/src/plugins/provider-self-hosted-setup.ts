...
export function applyProviderDefaultModel(cfg: DiffractionConfig, modelRef: string): DiffractionConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: DiffractionConfig; modelId: string; modelRef: string; profileId: string } {
