...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: DiffractionConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: DiffractionConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: DiffractionConfig) => string;
  setAccountEnabled?: (params: {
    cfg: DiffractionConfig;
    accountId: string;
    enabled: boolean;
  }) => DiffractionConfig;
  deleteAccount?: (params: { cfg: DiffractionConfig; accountId: string }) => DiffractionConfig;
  isEnabled?: (account: ResolvedAccount, cfg: DiffractionConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: DiffractionConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: DiffractionConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: DiffractionConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: DiffractionConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.diffraction.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: DiffractionConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: DiffractionConfig;
    nextCfg: DiffractionConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: DiffractionConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: DiffractionConfig; accountId?: string | null }) =>
    | {
