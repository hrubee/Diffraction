...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: DiffractionConfig): string | undefined {
  ...
  function listAccountIds(cfg: DiffractionConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: DiffractionConfig): string {
