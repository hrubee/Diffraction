...
export type ChannelAgentToolFactory = (params: { cfg?: DiffractionConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: DiffractionConfig; accountId?: string | null }) => string[];
};
