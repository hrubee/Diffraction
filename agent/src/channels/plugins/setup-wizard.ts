...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: DiffractionConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: DiffractionConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: DiffractionConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: DiffractionConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: DiffractionConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: DiffractionConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: DiffractionConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: DiffractionConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: DiffractionConfig;
    accountId: string;
