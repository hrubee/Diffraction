...
export type DiffractionHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "diffraction-bundled" | "diffraction-managed" | "diffraction-workspace" | "diffraction-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: DiffractionHookMetadata;
