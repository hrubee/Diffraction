...
function makeCfg(overrides?: Partial<DiffractionConfig>): DiffractionConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): DiffractionConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: DiffractionConfig) {
