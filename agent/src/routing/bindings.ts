...
export function listBindings(cfg: DiffractionConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: DiffractionConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DiffractionConfig) {
