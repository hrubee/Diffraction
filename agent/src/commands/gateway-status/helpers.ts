...
import type { DiffractionConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: DiffractionConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: DiffractionConfig) {
