...
export function applyLitellmProviderConfig(cfg: DiffractionConfig): DiffractionConfig {
...
export function applyLitellmConfig(cfg: DiffractionConfig): DiffractionConfig {
