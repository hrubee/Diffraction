...
export function scanDiscordNumericIdEntries(cfg: DiffractionConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(cfg: DiffractionConfig): {
