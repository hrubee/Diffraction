...
function collectExecSafeBinScopes(cfg: DiffractionConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: DiffractionConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: DiffractionConfig): {
