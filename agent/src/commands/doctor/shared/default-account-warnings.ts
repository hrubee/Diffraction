...
export function collectMissingDefaultAccountBindingWarnings(cfg: DiffractionConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: DiffractionConfig): string[] {
  const warnings: string[] = [];
