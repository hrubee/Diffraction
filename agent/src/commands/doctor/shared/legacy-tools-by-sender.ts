...
export function scanLegacyToolsBySenderKeys(cfg: DiffractionConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: DiffractionConfig): {
