...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set DIFFRACTION_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `diffraction dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Diffraction.");
  } else if (hint) {
    runtime.log(hint);
  }
}
