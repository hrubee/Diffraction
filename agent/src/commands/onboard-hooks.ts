...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.diffraction.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("diffraction hooks list")}`,
      `  ${formatCliCommand("diffraction hooks enable <name>")}`,
      `  ${formatCliCommand("diffraction hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
