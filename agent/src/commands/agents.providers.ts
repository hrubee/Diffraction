...
function resolveDefaultAccountId(cfg: DiffractionConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: DiffractionConfig): boolean {
...
export function summarizeBindings(cfg: DiffractionConfig, bindings: AgentBinding[]): string[] {
