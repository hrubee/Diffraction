...
const CORE_PACKAGE_NAMES = new Set(["diffraction"]);
...
export async function resolveDiffractionPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveDiffractionPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
