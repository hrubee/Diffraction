...
function resolveMentionPatterns(cfg: DiffractionConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: DiffractionConfig | undefined, agentId?: string): RegExp[] {
