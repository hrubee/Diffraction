...
function resolveAcpStreamCoalesceIdleMs(cfg: DiffractionConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: DiffractionConfig): number {
...
export function resolveAcpProjectionSettings(cfg: DiffractionConfig): AcpProjectionSettings {
