...
function createMatrixThreadCommandParams(commandBody: string, cfg: DiffractionConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: DiffractionConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
