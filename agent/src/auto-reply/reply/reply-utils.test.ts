...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bdiffraction\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "Diffraction" },
        expected: "[Diffraction]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "Diffraction",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[Diffraction] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
