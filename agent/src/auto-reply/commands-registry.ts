...
export function isCommandEnabled(cfg: DiffractionConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: DiffractionConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: DiffractionConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: DiffractionConfig) {
