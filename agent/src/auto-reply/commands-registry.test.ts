...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@diffraction", { botUsername: "diffraction" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@diffraction args", {
        botUsername: "diffraction",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@diffraction: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "diffraction" })).toBe(
      "/help@otherbot",
    );
  });
