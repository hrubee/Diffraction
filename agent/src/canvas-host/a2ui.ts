...
export const A2UI_PATH = "/__diffraction__/a2ui";

export const CANVAS_HOST_PATH = "/__diffraction__/canvas";

export const CANVAS_WS_PATH = "/__diffraction__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.diffractionCanvasA2UIAction.postMessage(...)
  // - Android: window.diffractionCanvasA2UIAction.postMessage(...)
  const handlerNames = ["diffractionCanvasA2UIAction"];
  ...
  globalThis.Diffraction = globalThis.Diffraction ?? {};
  globalThis.Diffraction.postMessage = postToNode;
  globalThis.Diffraction.sendUserAction = sendUserAction;
  globalThis.diffractionPostMessage = postToNode;
  globalThis.diffractionSendUserAction = sendUserAction;
