...
let originalDiffractionTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalDiffractionTestConsole = process.env.DIFFRACTION_TEST_CONSOLE;
  process.env.DIFFRACTION_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalDiffractionTestConsole === undefined) {
    delete process.env.DIFFRACTION_TEST_CONSOLE;
  } else {
    process.env.DIFFRACTION_TEST_CONSOLE = originalDiffractionTestConsole;
  }
