...
import type {
  ...
  DiffractionPluginApi as CoreDiffractionPluginApi,
...
import type { DiffractionPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  DiffractionPluginApi as SharedDiffractionPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreDiffractionPluginApi>().toMatchTypeOf<DiffractionPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreDiffractionPluginApi>().toMatchTypeOf<SharedDiffractionPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("diffraction/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`diffraction/plugin-sdk/${id}`),
      ),
    ]);
