...
import type { DiffractionPluginApi, DiffractionPluginConfigSchema } from "../plugins/types.js";
...
export type { DiffractionPluginApi } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  description: string;
  plugin: TPlugin;
  configSchema?: DiffractionPluginConfigSchema | (() => DiffractionPluginConfigSchema);
  setRuntime?: (runtime: PluginRuntime) => void;
  registerFull?: (api: DiffractionPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: DiffractionConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
