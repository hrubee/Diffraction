...
const shouldWarnCompatImport =
  ...
  process.env.DIFFRACTION_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "diffraction/plugin-sdk/compat is deprecated for new plugins. Migrate to focused diffraction/plugin-sdk/<subpath> imports. See https://docs.diffraction.ai/plugins/sdk-migration",
    {
      code: "DIFFRACTION_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.diffraction.ai/plugins/sdk-migration",
    },
  );
}
