...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("diffraction.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("diffraction.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: DiffractionConfig): Promise<ContextEngine> {
