...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DiffractionConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DiffractionConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: DiffractionConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DiffractionConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: DiffractionConfig }): Promise<void> {
