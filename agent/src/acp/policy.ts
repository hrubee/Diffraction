...
export function isAcpEnabledByPolicy(cfg: DiffractionConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: DiffractionConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: DiffractionConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: DiffractionConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: DiffractionConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: DiffractionConfig, agentId: string): boolean {
