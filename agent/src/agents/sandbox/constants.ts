...
export const DEFAULT_SANDBOX_IMAGE = "diffraction-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "diffraction-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "diffraction-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "diffraction-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "diffraction-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "diffraction-sandbox-browser";
