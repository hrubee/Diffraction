...
function resolveWatchPaths(workspaceDir: string, config?: DiffractionConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DiffractionConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DiffractionConfig }) {
