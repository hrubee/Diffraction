...
function resolveAnthropicOpusThinking(cfg: DiffractionConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<DiffractionConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<DiffractionConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<DiffractionConfig> = {
        agents: {
          defaults: {
            models: {
