...
const DIFFRACTION_ATTRIBUTION_PRODUCT = "Diffraction";
const DIFFRACTION_ATTRIBUTION_ORIGINATOR = "diffraction";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: DIFFRACTION_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: DIFFRACTION_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${DIFFRACTION_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
