...
export function resolveSessionToolsVisibility(cfg: DiffractionConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: DiffractionConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: DiffractionConfig): AgentToAgentPolicy {
