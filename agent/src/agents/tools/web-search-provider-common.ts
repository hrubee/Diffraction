...
export type SearchConfigRecord = (NonNullable<DiffractionConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("diffraction.web-search.cache");
