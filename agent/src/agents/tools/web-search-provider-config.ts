...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<DiffractionConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<DiffractionConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: DiffractionConfig): WebSearchConfig {
...
export function setProviderWebSearchPluginConfigValue(
  configTarget: DiffractionConfig,
  pluginId: string,
  key: string,
  value: unknown,
): void {
