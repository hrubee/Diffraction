...
function resolveMemoryToolContext(options: { config?: DiffractionConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: DiffractionConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: DiffractionConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: DiffractionConfig): MemoryCitationsMode {
