...
type DiffractionReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: DiffractionReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDiffractionReadTool(base, {
...
export function createDiffractionReadTool(
  base: AnyAgentTool,
  options?: DiffractionReadToolOptions,
): AnyAgentTool {
