...
const CLEANUP_STATE_KEY = Symbol.for("diffraction.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("diffraction.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("diffraction.sessionWriteLockWatchdogState");
