...
describe("Agent-specific tool filtering", () => {
  ...
  async function withApplyPatchEscapeCase(
    ...
    const workspaceDir = await fs.mkdtemp(path.join(os.tmpdir(), "diffraction-pi-tools-"));
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: DiffractionConfig) {
    return createDiffractionCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<DiffractionConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<DiffractionConfig["agents"]>["list"]>[number]["tools"];
  }): DiffractionConfig {
    return {
      tools: params.tools,
      agents: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createDiffractionCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createDiffractionCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createDiffractionCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createDiffractionCodingTools({
      config: cfg,
    ...
    const bobTools = createDiffractionCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createDiffractionCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createDiffractionCodingTools({
      config: cfg,
