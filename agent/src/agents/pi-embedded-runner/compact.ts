...
function resolvePostCompactionIndexSyncMode(config?: DiffractionConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureDiffractionModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createDiffractionCodingTools({
      exec: {
