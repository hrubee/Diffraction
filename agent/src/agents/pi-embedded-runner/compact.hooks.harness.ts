...
export const createDiffractionCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createDiffractionCodingToolsMock.mockReset();
  createDiffractionCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureDiffractionModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveDiffractionDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createDiffractionCodingTools: createDiffractionCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveDiffractionAgentDir: vi.fn(() => "/tmp"),
  }));
