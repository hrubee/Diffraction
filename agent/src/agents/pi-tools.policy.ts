...
export function resolveSubagentToolPolicy(cfg?: DiffractionConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: DiffractionConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: DiffractionConfig["tools"];
