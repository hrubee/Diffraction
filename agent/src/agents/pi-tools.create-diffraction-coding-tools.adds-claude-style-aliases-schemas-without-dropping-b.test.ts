...
const defaultTools = createDiffractionCodingTools({ senderIsOwner: true });
...
describe("createDiffractionCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: DiffractionConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createDiffractionCodingTools({
    ...
    const anthropicTools = createDiffractionCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: DiffractionConfig = {
      tools: {
        exec: {
    ...
    const allowed = createDiffractionCodingTools({
    ...
    const denied = createDiffractionCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createDiffractionCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
