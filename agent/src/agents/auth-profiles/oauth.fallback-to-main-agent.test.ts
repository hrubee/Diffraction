...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveDiffractionAgentDir() returns mainAgentDir
    process.env.DIFFRACTION_STATE_DIR = tmpDir;
    process.env.DIFFRACTION_AGENT_DIR = mainAgentDir;
