...
export function isCliProvider(provider: string, cfg?: DiffractionConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: DiffractionConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: DiffractionConfig }): ModelCatalogEntry[] {
