...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "diffraction-sbx-test",
    runtimeLabel: params.containerName ?? "diffraction-sbx-test",
    containerName: params.containerName ?? "diffraction-sbx-test",
