...
function resolveAvatarSource(cfg: DiffractionConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DiffractionConfig, agentId: string): AgentAvatarResolution {
