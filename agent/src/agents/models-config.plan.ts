...
type ModelsConfig = NonNullable<DiffractionConfig["models"]>;
...
function resolveExplicitBaseUrlProviders(
  providers: DiffractionConfig["models"] | undefined,
): ReadonlySet<string> {
  return new Set(
...
export async function planDiffractionModelsJson(params: {
  cfg: DiffractionConfig;
