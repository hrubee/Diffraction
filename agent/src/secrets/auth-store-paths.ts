...
export function listAuthProfileStorePaths(config: DiffractionConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: DiffractionConfig, stateDir: string): string[] {
