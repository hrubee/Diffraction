...
type FetchConfig = NonNullable<DiffractionConfig["tools"]>["web"] extends infer Web
...
function hasCustomWebSearchPluginRisk(config: DiffractionConfig): boolean {
...
function setResolvedWebSearchApiKey(params: {
  resolvedConfig: DiffractionConfig;
