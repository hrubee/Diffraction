...
function resolveResolutionLimits(config: DiffractionConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: DiffractionConfig): SecretProviderConfig {
