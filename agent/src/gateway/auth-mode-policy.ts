...
export function hasAmbiguousGatewayAuthModeConfig(cfg: DiffractionConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: DiffractionConfig): void {
