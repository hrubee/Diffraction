import type { GatewayAuthConfig, DiffractionConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: DiffractionConfig, password: string): DiffractionConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
