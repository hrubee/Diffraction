...
const EMPTY_CFG = {} as DiffractionConfig;
...
async function applySubagentModelPatch(cfg: DiffractionConfig) {
...
function createAllowlistedAnthropicModelCfg(): DiffractionConfig {
  return {
    agents: {
      defaults: {
