  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set DIFFRACTION_GATEWAY_TOKEN/DIFFRACTION_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.DIFFRACTION_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
