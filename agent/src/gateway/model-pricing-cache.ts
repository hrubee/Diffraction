...
export function collectConfiguredModelPricingRefs(config: DiffractionConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: DiffractionConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
