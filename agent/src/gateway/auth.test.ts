...
describe("gateway auth", () => {
  ...
  it("resolves token/password from DIFFRACTION gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          DIFFRACTION_GATEWAY_TOKEN: "env-token",
          DIFFRACTION_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides DIFFRACTION_GATEWAY_PASSWORD", () => {
