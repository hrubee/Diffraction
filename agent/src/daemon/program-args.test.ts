...
describe("resolveGatewayProgramArguments", () => {
  it("uses realpath-resolved dist entry when running via npx shim", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/diffraction");
    const entryPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/diffraction/dist/entry.js");
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/diffraction is a symlink
    // to .pnpm/diffraction@X.Y.Z/node_modules/diffraction
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/diffraction/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/diffraction@2026.1.21-2/node_modules/diffraction/dist/entry.js",
    );
  ...
  it("falls back to node_modules package dist when .bin path is not resolved", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/diffraction");
    const indexPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/diffraction/dist/index.js");
    process.argv = ["node", argv1];
