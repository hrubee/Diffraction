import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "diffraction/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "diffraction/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "diffraction/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/diffraction"),
    },
    modelAuth: {
