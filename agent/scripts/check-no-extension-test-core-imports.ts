...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']diffraction\/plugin-sdk["']/,
    hint: "Use diffraction/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']diffraction\/plugin-sdk\/test-utils["']/,
    hint: "Use diffraction/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']diffraction\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or diffraction/plugin-sdk/testing for public surfaces.",
  },
  {
