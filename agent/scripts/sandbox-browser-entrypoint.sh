...
export DISPLAY=:1
export HOME=/tmp/diffraction-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${DIFFRACTION_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${DIFFRACTION_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${DIFFRACTION_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${DIFFRACTION_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${DIFFRACTION_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${DIFFRACTION_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${DIFFRACTION_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${DIFFRACTION_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${DIFFRACTION_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${DIFFRACTION_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${DIFFRACTION_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
