...
if [[ -z "$version_content" ]]; then
  echo "<h2>Diffraction $VERSION</h2>"
  echo "<p>Latest Diffraction update.</p>"
  echo "<p><a href=\"https://github.com/diffraction/diffraction/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
