...
show_usage() {
    cat << EOF
clawlog - Diffraction Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Diffraction logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Diffraction logs flow through the macOS unified log (subsystem: ai.diffraction).
