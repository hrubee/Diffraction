...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "diffraction", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Diffraction. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Diffraction Issue Label Audit");
