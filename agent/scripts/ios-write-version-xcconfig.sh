...
- DIFFRACTION_GATEWAY_VERSION = exact package.json version
- DIFFRACTION_MARKETING_VERSION = short iOS/App Store version
- DIFFRACTION_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
DIFFRACTION_GATEWAY_VERSION = ${PACKAGE_VERSION}
DIFFRACTION_MARKETING_VERSION = ${MARKETING_VERSION}
DIFFRACTION_BUILD_VERSION = ${BUILD_NUMBER}
EOF
