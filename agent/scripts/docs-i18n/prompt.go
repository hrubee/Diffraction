...
- Keep product names in English: Diffraction, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Diffraction Gateway, use “Gateway 网关”.
