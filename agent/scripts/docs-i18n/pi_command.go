...
const (
	envDocsPiExecutable     = "DIFFRACTION_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "DIFFRACTION_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "DIFFRACTION_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "diffraction", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
