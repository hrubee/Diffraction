...
#
# Output:
# - dist/Diffraction.app
# - dist/Diffraction-<version>.zip
# - dist/Diffraction-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.diffraction.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Diffraction.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Diffraction-$VERSION.zip"
DMG="$ROOT_DIR/dist/Diffraction-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Diffraction-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Diffraction-$VERSION.dSYM.zip"
