...
impl Product {
    /// Create the standard `Diffract` Sandbox Supervisor product.
    #[must_use]
    pub fn diffract_sandbox(version: &str) -> Self {
        Self {
            name: "Diffract Sandbox Supervisor".to_string(),
...
mod tests {
    ...
    fn test_metadata_serialization() {
        ...
        assert_eq!(json["product"]["name"], "Diffract Sandbox Supervisor");
        assert_eq!(json["product"]["vendor_name"], "Diffract");
