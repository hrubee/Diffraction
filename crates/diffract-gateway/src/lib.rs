...
//! `Diffract` Server library.
//!
//! This crate provides the server implementation for `Diffract`, including:
...
use diffract_core::{Config, Error, Result};
