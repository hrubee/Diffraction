...
fn render_connect_page(
    ...
    let version = diffract_core::VERSION;
...
<head>
    ...
    <title>Diffract — Connect to Gateway</title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="hint">
            This will authorize the Diffract CLI to connect to this gateway.
        </div>
    ...
    <script>
        ...
        function connect() {{
            ...
            .catch(function(err) {{
                ...
                btn.textContent = 'Connect to Gateway';
                status.className = 'status status-err';
                status.textContent = 'Could not reach the CLI. Is diffract still running?';
            }});
        }}
    </script>
</body>
