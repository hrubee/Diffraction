...
//! Shared sandbox policy parsing and defaults for Diffract.
//!
...
pub const CONTAINER_POLICY_PATH: &str = "/etc/diffract/policy.yaml";

/// Legacy path used before the navigator → diffract rename.
///
...
"#;
    ...
    fn container_policy_path_is_expected() {
        assert_eq!(CONTAINER_POLICY_PATH, "/etc/diffract/policy.yaml");
    }
