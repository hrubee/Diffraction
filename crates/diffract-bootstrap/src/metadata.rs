...
use diffract_core::paths::ensure_parent_dir_restricted;
...
///
/// Scans `$XDG_CONFIG_HOME/diffract/gateways/` for subdirectories containing
...
mod tests {
    ...
    fn metadata_roundtrip() {
        let meta = GatewayMetadata {
            ...
            is_remote: true,
            gateway_port: 8080,
            remote_host: Some("user@diffract-dev".to_string()),
