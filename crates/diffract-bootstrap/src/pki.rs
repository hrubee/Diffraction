...
const DEFAULT_SERVER_SANS: &[&str] = &[
    "diffract",
    "diffract.diffract.svc",
    "diffract.diffract.svc.cluster.local",
    "localhost",
...
pub fn generate_pki(extra_sans: &[String]) -> Result<PkiBundle> {
    ...
    ca_params
        .distinguished_name
        .push(DnType::OrganizationName, "diffract");
    ca_params
        .distinguished_name
        .push(DnType::CommonName, "diffract-ca");
    ...
    server_params
        .distinguished_name
        .push(DnType::CommonName, "diffract-server");
    ...
    client_params
        .distinguished_name
        .push(DnType::CommonName, "diffract-client");
