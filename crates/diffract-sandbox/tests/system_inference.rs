...
use diffract_router::config::{AuthHeader, ResolvedRoute};
use diffract_sandbox::proxy::InferenceContext;
...
async fn system_inference_routes_to_mock_backend() {
    ...
    let patterns = diffract_sandbox::l7::inference::default_patterns();
