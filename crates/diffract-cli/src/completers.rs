...
use diffract_bootstrap::{list_gateways, load_active_gateway, load_gateway_metadata};
use diffract_core::proto::open_shell_client::DiffractClient;
use diffract_core::proto::{ListProvidersRequest, ListSandboxesRequest};
...
async fn completion_grpc_client(
    ...
    Some(DiffractClient::new(channel))
}
...
mod tests {
    ...
    use diffract_bootstrap::{GatewayMetadata, store_gateway_metadata};
