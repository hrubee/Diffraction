...
| [Diffraction](https://diffraction.ai/)                              | [Community](https://github.com/NVIDIA/OpenShell-Community)                       | Launch with `openshell sandbox create --from diffraction`.                       |
...
```bash
openshell sandbox create --from diffraction           # community catalog
