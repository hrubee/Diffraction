...
| [Diffraction](https://diffraction.ai/) | [`diffraction`](https://github.com/NVIDIA/OpenShell-Community/tree/main/sandboxes/diffraction) | Bundled | Agent orchestration layer. Launch with `openshell sandbox create --from diffraction`. |
