...
export function checkCompatibility(
  ...
  if (
    manifest.minDiffractionVersion &&
    !satisfiesMinVersion(diffractionVersion, manifest.minDiffractionVersion)
  ) {
    errors.push(`Diffraction version ${diffractionVersion} < required ${manifest.minDiffractionVersion}`);
  }
