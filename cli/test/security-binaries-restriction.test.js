...
const BASELINE = path.join(import.meta.dirname, "..", "diffract-blueprint", "policies", "openclaw-sandbox.yaml");
const PRESETS_DIR = path.join(import.meta.dirname, "..", "diffract-blueprint", "policies", "presets");
