---
title:
  page: "Approve or Deny Diffraction Agent Network Requests"
  nav: "Approve Network Requests"
description: "Review and approve blocked agent network requests in the TUI."
keywords: ["diffraction approve network requests", "sandbox egress approval tui"]
...
```console
$ ssh my-gpu-box 'cd /home/ubuntu/diffraction && . .env && openshell term'
```
