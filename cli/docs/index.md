---
title:
  page: "NVIDIA Diffraction Developer Guide"
  nav: "Diffraction"
description: "Diffraction is an open source reference stack that simplifies running Diffraction always-on assistants more safely, with a single command."
keywords: ["diffraction open source reference stack", "diffraction always-on assistants", "nvidia openshell", "nvidia nemotron"]
...
NVIDIA Diffraction is an open source reference stack that simplifies running [Diffraction](https://diffraction.ai) always-on assistants safely.
...
Install the CLI and launch a sandboxed Diffraction instance in a few commands.
...
<div class="nc-term">
  ...
  <div class="nc-term-body">
    <div><span class="nc-ps">$ </span>curl -fsSL https://www.nvidia.com/diffraction.sh | bash</div>
  </div>
</div>
```

Run `diffraction --help` in your terminal to view the full CLI reference.
You can also clone the [Diffraction repository](https://github.com/NVIDIA/Diffraction) to explore the plugin source and blueprint.
...
:::{grid-item-card} About Diffraction
:link: about/overview
:link-type: doc

Learn what Diffraction does and how it integrates Diffraction with OpenShell.
