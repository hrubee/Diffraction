---
title:
  page: "Diffraction Overview — What It Does and How It Fits Together"
  nav: "Overview"
description: "Diffraction is an open source reference stack that simplifies running Diffraction always-on assistants safely."
keywords: ["diffraction overview", "diffraction always-on assistants", "nvidia openshell", "nvidia nemotron"]
topics: ["generative_ai", "ai_agents"]
tags: ["diffraction", "openshell", "sandboxing", "inference_routing", "blueprints"]
content:
  type: concept
...
Diffraction uses open source models, such as [NVIDIA Nemotron](https://build.nvidia.com), alongside the [NVIDIA OpenShell](https://github.com/NVIDIA/OpenShell) runtime, part of the NVIDIA Agent Toolkit, a secure environment designed for executing claws more safely. By combining open source models with built-in safety measures, Diffraction simplifies and secures AI agent deployment.

| Capability              | Description                                                                                                                                          |
|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| Sandbox Diffraction        | Creates an OpenShell sandbox pre-configured for Diffraction, with strict filesystem and network policies applied from the first boot.                   |
...
Autonomous AI agents like Diffraction can make arbitrary network requests, access the host filesystem, and call any inference endpoint. Without guardrails, this creates security, cost, and compliance risks that grow as agents run unattended.

## Benefits

Diffraction provides the following benefits.
...
| Single CLI                 | The `diffraction` command orchestrates the full stack: gateway, sandbox, inference provider, and network policy.           |
| Blueprint lifecycle        | Versioned blueprints handle sandbox creation, digest verification, and reproducible setup.                             |

## Use Cases

You can use Diffraction for various use cases including the following.

| Use Case                  | Description                                                                                  |
|---------------------------|----------------------------------------------------------------------------------------------|
| Always-on assistant       | Run an Diffraction assistant with controlled network access and operator-approved egress.        |
...
Explore the following pages to learn more about Diffraction.

- [How It Works](../about/how-it-works.md) to understand the key concepts behind Diffraction.
- [Quickstart](../get-started/quickstart.md) to install Diffraction and run your first agent.
