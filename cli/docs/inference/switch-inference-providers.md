---
title:
  page: "Switch Diffraction Inference Models at Runtime"
  nav: "Switch Inference Models"
description: "Change the active inference model without restarting the sandbox."
keywords: ["switch diffraction inference model", "change inference runtime"]
topics: ["generative_ai", "ai_agents"]
tags: ["diffraction", "openshell", "inference_routing"]
content:
  type: how_to
...
The `diffraction onboard` command stores this key in `~/.diffraction/credentials.json` on first run.
