# Contributing to Diffraction Documentation

This guide covers how to write, edit, and review documentation for Diffraction. If you change code that affects user-facing behavior, update the relevant docs in the same PR.
...
| Diffraction | diffraction (in prose), Nemoclaw |
| Diffraction | diffraction (in prose), Openclaw |
