...
- You must be in the Diffraction git repository (`Diffraction`).
...
2. **Files changed**: Changes to `diffraction/src/`, `diffraction-blueprint/`, `bin/`, `scripts/`, or policy-related code are high-signal.
...
|---|---|
| `diffraction/src/commands/` (launch, connect, status, logs) | `docs/reference/commands.md` |
| `diffraction/src/commands/` (new command) | May need a new page or entry in `docs/reference/commands.md` |
| `diffraction/src/blueprint/` | `docs/about/architecture.md` |
| `diffraction/src/cli.ts` or `diffraction/src/index.ts` | `docs/reference/commands.md`, `docs/get-started/quickstart.md` |
| `diffraction-blueprint/orchestrator/` | `docs/about/architecture.md` |
| `diffraction-blueprint/policies/` | `docs/reference/network-policies.md` |
| `diffraction-blueprint/blueprint.yaml` | `docs/about/architecture.md`, `docs/reference/inference-profiles.md` |
...
- **Always capitalize Diffraction correctly.** Wrong: diffraction (in prose), Nemoclaw.
